                                ...
                                if ($user['role_id'] == 3) { ?>
                                    <?php if ($row['status_pengajuan'] == 'belum diproses') { ?>
                                        <td><a name="detail_order" id="detail_order" class="btn btn-info" href="<?= base_url('') ?>requestorder/get_id/<?= $row['kode_ro']; ?>" role="button"><i class="fas fa-info-circle"></i></a>
                                            ...
                                            <a name="detail_order" id="detail_order" class="btn btn-success" href="<?= base_url('') ?>requestorder/ro_approval/<?= $row['id_ro']; ?>" role="button"><i class="fa fa-check"></i></a>
                                            <a name="detail_order" id="detail_order" class="btn btn-danger" href="<?= base_url('') ?>requestorder/ro_reject/<?= $row['id_ro']; ?>" role="button"><i class="fa fa-times"></i></a>
                                            <!--btn-->
                                        </td>
                                    <?php } else { ?>
